...
use App\Http\Controllers\API\OneTimeJobsController;
...
*/
  ...
  Route::get('databaseBackup', 'API\PreLoginController@databaseBackup');
  ...
  // 
    ...
    // Route::any("airfareDiscount","API\OneTimeJobsController@airfareDiscount");
    // Route::any("onlinePaymentStatusAndStatusIs0","API\OneTimeJobsController@onlinePaymentStatusAndStatusIs0");
    // Route::any("onlinePaymentStatus7AndStatusIs0","API\OneTimeJobsController@onlinePaymentStatus7AndStatusIs0");
    // Route::any("acceptanceSendAccordingToLanguage","API\OneTimeJobsController@acceptanceSendAccordingToLanguage");
    Route::any("acceptanceEmailSend","API\OneTimeJobsController@acceptanceEmailSend");
