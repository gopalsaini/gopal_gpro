	...
	public static function ApiMessageTranslaterLabel($lang,$word){
		...
		if($lang == 'sp'){
			...
			$data=array(
				...
				'Yourregistration-hasbeen-completedsuccessfullyPlease-updateyourprofile' => 'Su registro se ha completado con éxito. Por favor, actualice su perfil',	
			...
			$data=array(
				...
				'Yourregistration-hasbeen-completedsuccessfullyPlease-updateyourprofile' => "Votre inscription a été complétée avec succès. Veuillez mettre à jour votre profil",	
			...
			$data=array(
				...
				'Payment-Successful' => 'Payment Successful',	
				'Sponsor-Submitted-Payment' => 'Payment Successful',	
				...
				'Please-submityourprofile-dataOnour-website' => 'Something happened, please try again later',	
