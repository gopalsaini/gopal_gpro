    ...
    <div class="inner-banner-wrapper">
        <div class="container custom-container2">
            <div class="step-form-wrap step-preview-wrap">
                ...
                $exhibitors=\App\Models\Exhibitors::where('user_id',$resultData['result']['id'])->first();
                @endphp
            ...
            <div class="step-form">
                ...
                <!-- //Vineet - 080123 -->
                    <div class="detail-wrap">
                        <ul>
                            <li>
                                <p>Given @lang('web/profile.name')</p>
                                <span>:&nbsp; &nbsp; &nbsp; 
                                     
                                {{$resultData['result']['name']}} </span>
                            </li>
                            <li>
                                <p>Surname</p>
                                <span>:&nbsp; &nbsp; &nbsp; 
                                     
                                {{$exhibitors['last_name']}}</span>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <span>:&nbsp; &nbsp; &nbsp; @if($exhibitors['dob']!=''){{ date('d-m-Y',strtotime($exhibitors['dob'])) }}@endif</span>
                            </li>
                        </ul>
                        <ul>
                            <li>
                    ...
                    <div class="detail-wrap">
                        <ul>
                            @if($exhibitors['business_identification_no'])
                                <li>
                                    <p>Business Identification No</p>
                                    <span>:&nbsp; &nbsp; &nbsp; {{$exhibitors['business_identification_no']}}</span>
                                </li>
                            @endif
                            @if($exhibitors['website'])
                                <li>
                                    <p>Website</p>
                                    <span>:&nbsp; &nbsp; &nbsp; {{$exhibitors['website']}}</span>
                                </li>
                            @endif
                            @if($exhibitors['logo'])
                                <li>
                                    <p>Logo</p>
                                    <span>:&nbsp; &nbsp; &nbsp; <a target="_blank" href="{{asset('uploads/logo/'.$exhibitors['logo'])}}">View</a></span>
                                </li>
                            @endif
                        ...
                        <ul>
                            <li>
                                <p>Passport Number</p>
                                <span>:&nbsp; &nbsp; &nbsp; {{$exhibitors['passport_number']}}</span>
                            </li>
                            <li>
                                <p>Passport Copy</p>
                                <span>:&nbsp; &nbsp; &nbsp; 
                                   
                                <a target="_blank" href="{{asset('uploads/passport/'.$exhibitors['passport_copy'])}}">View</a>
