...
@section('title',__(Lang::get('web/payment.group').Lang::get('web/payment.info')))
            ...
            <div class="step-form">
                <div class="group-table">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <th>@lang('web/home.sr-no')</th>
                                <th>@lang('web/home.name')</th>
                                <th>@lang('web/home.stage') - 01</th>
                                <th>@lang('web/home.stage') - 02</th>
                                <th>@lang('web/home.stage') - 03</th>
                                <th>@lang('web/home.stage') - 04</th>
                                <th>@lang('web/home.stage') - 05</th>
                            </tr>
                        </thead>
                        <tbody>
                            @if(!empty($groupInfoResult) && count($groupInfoResult)>0) 
                                ...
                                @php $val=\App\Models\User::where('parent_id',$data->id)->where('added_as','Spouse')->first(); @endphp
                                    <tr>
                                        ...
                                        <td class="">
                                            @if($data->stage == 1)
                                                <div class="inprogress">@lang('web/home.in-process')</div>
                                            @elseif($data->stage > 1)
                                                <div class="complete">@lang('web/home.completed')</div>
                                            @else
                                                <div class="pending">@lang('web/home.pending')</div>
                                            @endif
                                        </td>
                                        <td class="">
                                            @if($data->stage == 2)
                ...
                <div class="register-next">
                    <a href="{{url('profile')}}" class="main-btn bg-gray-btn">@lang('web/contact-details.next')</a>
                </div>
            </div>
    </div>
    <!-- banner-end -->
