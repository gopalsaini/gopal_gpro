...
@section('content')
    ...
    <div class="inner-banner-wrapper">
        <div class="container">
            <div class="step-form">
                <h4 class="text-center">@lang('web/spouse-details.title')</h4>
                <form id="formSubmit" action="{{ route('groupinfo-update') }}" class="row" enctype="multipart/form-data">
                    <div class="group-main">
                        <label  class="main-btn bg-gray-btn yes-btn" for="isgrpup_yes" style="cursor:pointer">@lang('web/spouse-details.yes')</label>
                        <input type="radio" name="is_group" value="Yes" required id="isgrpup_yes"  style="display:none"/>
                        <label class="main-btn bg-gray-btn no-btn" for="isgrpup_no"  style="cursor:pointer">@lang('web/spouse-details.no')</a>
                        <input type="radio" name="is_group" value="No" required id="isgrpup_no" style="display:none"/>
                    </div>
                    <div class="yes-table"> 
                        <div class="group-register-box">
                            <div class="fieldsGroup">
                                <div class="row tbContainer">
                                    ...
                                    <div class="col-lg-4">
                                        <label for="">@lang('web/spouse-details.email')</label>
                                        <input type="text" placeholder="@lang('web/app.enter') @lang('web/spouse-details.email')" class="mt-2"  name="email[]">
                                    </div>
                                    <div class="col-lg-4">
                                        <label for="">@lang('web/spouse-details.whatsapp')</label>
                                        <input type="text" placeholder="@lang('web/app.enter') @lang('web/spouse-details.whatsapp')" class="mt-2"  onkeypress="return /[0-9 ]/i.test(event.key)" name="whatsup[]">
                                    </div>
                                    <div class="col-lg-4">
                                        <label for="">@lang('web/spouse-details.mobile')</label>
                                        <input type="text" placeholder="@lang('web/app.enter') @lang('web/spouse-details.mobile')" class="mt-2" onkeypress="return /[0-9 ]/i.test(event.key)"  name="mobile[]">
                                        {{-- <button class="remove hidden">Remove</button> --}}
                                    </div>  
                                </div>
                                <div class="add-remove-btn">
                                    <a href="javascript:;" class="add-btn remove-btn">
                                        <span>
                                        ...
                                        @lang('web/spouse-details.delete')
                                    </a>
                                    <a href="javascript:;" class="addInput add-btn remove hidden">
                                        ...
                                        @lang('web/spouse-details.add') @lang('web/spouse-details.more')
                                    </a>
                                </div>
                            </div>
                        </div> 
                    ...
                    <div class="table-btn"> 
                        <button type="submit" class="main-btn bg-gray-btn" form="formSubmit">@lang('web/spouse-details.submit')</button>
                    </div> 
                </form>
                <div class="no-table">
                </div>
