                                                            ...
                                                            <td class="pad">
                                                                <div style="font-family:sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p>Dear {{$name}},</p><p><br></p><p>{{$userName}} has chosen you as his sponsor.</p><p><br></p><p>Please click here to make the payment.</p><p><br><a href="{{ url('sponsor-payment-link/'.$token) }}" >Click Here</a>
                                                                        </p><p>Warmly,</p><p>GProCongress II Team</p>
