...
<html lang="en" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:v="urn:schemas-microsoft-com:vml">
	...
	<div class="row">
		...
		@elseif($lang == 'fr' )
			...
			<p >Cher  {{$salutation}} {{$name}},
			<br>Numéro de passeport : {{$passport_no}}
			<br>Pays : {{$citizenship}}</p>
			...
			<p>&nbsp;&nbsp;&nbsp;&nbsp;1.	Transferts de l'aéroport vers/depuis l'hôtel.
			<br>&nbsp;&nbsp;&nbsp;&nbsp;2.	Une chambre pour cinq nuits à l'hôtel Westin Playa Bonita Panama.
			<br>&nbsp;&nbsp;&nbsp;&nbsp;3.	Tous les repas pendant le congrès ; et
			<br>&nbsp;&nbsp;&nbsp;&nbsp;4.	Tout le matériel nécessaire pour le congrès.</p>
			...
			<p><img src="{{'data:image/png;base64,'.base64_encode(file_get_contents(public_path('images/rajiv_richard.png')))}}" style="width:100px;"></p><br>
			<p>Rajiv Richard</br> Coordinateur de GProCongress II</br> Email : info@gprocongress.org</p>

		@elseif($lang == 'pt' )

			<p >Caro nome {{$salutation}} {{$name}},
			<br>Número do passaporte: {{$passport_no}}
			<br>País: {{$citizenship}}</p>
			...
			<p>&nbsp;&nbsp;&nbsp;&nbsp;1.	Transferências do aeroporto para o hotel e vice-versa
			<br>&nbsp;&nbsp;&nbsp;&nbsp;2.	Um quarto para cinco noites no Westin Playa Bonita Panama Hotel.
			<br>&nbsp;&nbsp;&nbsp;&nbsp;3.	Todas as refeições durante o Congresso; e
			<br>&nbsp;&nbsp;&nbsp;&nbsp;4.	Todos os materiais para o Congresso.</p>
			...
			<p>Rajiv Richard</br> GProCongress II Coordinator</br> Email: info@gprocongress.org</p>
		@else
			<p >Dear {{$salutation}} {{$name}},
			<br>Passport Number: {{$passport_no}}
			<br>Country: {{$citizenship}}</p>
			...
			<p>&nbsp;&nbsp;&nbsp;&nbsp;1.	Airport transfe	rs to/from the hotel.</br>
				&nbsp;&nbsp;&nbsp;&nbsp;2.	A room for five nights at the Westin Playa Bonita Panama Hotel.</br>
				&nbsp;&nbsp;&nbsp;&nbsp;3.	All meals during the Congress; and</br>
				&nbsp;&nbsp;&nbsp;&nbsp;4.	All materials for the Congress.</p>
