...
@section('content')
    ...
    <div class="inner-banner-wrapper">
        <div class="container">
            <div class="step-form">
                <h4 class="text-center">Invite friends to GProCongress II</h4>
                <form id="formSubmit" action="{{ route('invite-user') }}" class="row" enctype="multipart/form-data">
                    
                    <div class="yes-table" style="display: block;"> 
                        <div class="group-register-box">
                            <div class="fieldsGroup">
                                
                                <div class="row tbContainer"> 
                                    <div class="col-lg-3">
                                        <label for="">@lang('web/group-details.name') <span>*</span></label>
