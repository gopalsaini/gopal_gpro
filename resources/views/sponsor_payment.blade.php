                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" >
                                        <button class="accordion-button" type="button" >
                                            @lang('web/home.payment-confirmation')
                                        </button>
                                    </h2>
                                            ...
                                            <div class="modal-body">
                                                <form id="formSubmit" action="{{ route('sponsor-payments-pay') }}" class="row" enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <input type="email" name="email" readonly placeholder="@lang('web/app.enter') @lang('web/sponsor-payment.email')" class="mt-2" required value="{{$linkPayment->email}}">
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <input type="tel" name="amount" required onkeypress="return /[0-9 ]/i.test(event.key)" value="{{$linkPayment->amount}}" placeholder="@lang('web/app.enter') @lang('web/sponsor-payment.requested-amount')" class="mt-2" >
                                                    </div>
