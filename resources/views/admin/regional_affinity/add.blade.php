...
@section('title')
@if($result) Edit @else Add @endif Regional Affinity @endsection
@section('content')
<style>
	hr {
...
<div class="container-fluid">
	<div class="page-header">
		<div class="row">
			<div class="col-sm-6">
				<h3>@if($result) @lang('admin.edit') @else @lang('admin.add') @endif Regional Affinity</h3>
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">@lang('admin.dashboard')</a></li>
					<li class="breadcrumb-item" aria-current="page">Regional Affinity</li>
					@if($result)
            ...
            <div class="bookmark">
                <ul>
                    <a href="{{ route('admin.regional_affinity.list') }}" class="btn btn-primary"><i class="fas fa-list me-2"></i> @lang('admin.list')</a>
                </ul>
            </div>
        </div>
		</div>
			...
			<div class="card">
				<div class="card-body add-post">
						...
						<div class="row">
							...
							<form id="form" action="{{ route('admin.regional_affinity.add') }}" method="post" enctype="multipart/form-data" autocomplete="off">
								@csrf
