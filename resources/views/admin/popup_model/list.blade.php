...
@section('title',__('Popup Model List'))
...
<div class="container-fluid">
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                <h3> Popup Model @lang('admin.list') </h3>
                <ol class="breadcrumb">
            ...
            <div class="col-sm-6">
                <div class="bookmark">
                    <ul>
                        <a href="{{ route('admin.popup-model.add') }}" class="btn btn-outline-primary"><i class="fas fa-plus me-2"></i>@lang('admin.add') Popup Model</a>
                    </ul>
                </div>
            </div>
            @endif
...
$(document).ready(function() {
    ...
    $('#tablelist').DataTable({
        ...
        "ajax": {
            "url": "{{ route('admin.popup-model.list') }}",
            "dataType": "json",
            "async": false,
            "type": "get",
...
function fill_datatable() {
    $('.-change').change(function() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "{{ route('admin.popup-model.status') }}",
            headers: {
