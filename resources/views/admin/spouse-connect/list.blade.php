...
@section('title',__('Spouse Member List'))
    ...
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="bookmark">
                    <ul>
                        <a href="{{ route('admin.spouse-connect.add') }}" class="btn btn-primary"><i class="fas fa-list me-2"></i> Add</a>
                    </ul>
                </div>
            </div>
        </div>
