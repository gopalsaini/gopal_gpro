...
@section('title',__('Testimonials List'))
...
<div class="container-fluid">
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                <h3> @lang('admin.testimonial') @lang('admin.list') </h3>
                <ol class="breadcrumb">
            ...
            <div class="col-sm-6">
                <div class="bookmark">
                    <ul>
                        <a href="{{ route('admin.testimonial.add') }}" class="btn btn-outline-primary"><i class="fas fa-plus me-2"></i>@lang('admin.add') @lang('admin.testimonial')</a>
                    </ul>
                </div>
            </div>
        </div>
