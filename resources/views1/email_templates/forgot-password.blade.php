                                                                ...
                                                                <div style="font-family:sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <p>Dear {{$name}},</p>
                                                                            <p><br></p>
                                                                            <p>We received notification that you have forgotten your password.&nbsp; Here’s a link you can use to reset your
                                                                                password: <a href="{{ url('reset-password/'.$to.'/'.$token) }}">Click Here</a></p>
                                                                            <p><br></p>
                                                                            <p>Didn’t ask to reset your password? Have any other questions? Simply reply to this email to speak with one of our
                                                                                team members.</p>
                                                                            <p><br></p>
                                                                            <p>Warmly,</p>
