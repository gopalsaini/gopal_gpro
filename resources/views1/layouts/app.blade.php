...
<head>
    ...
    <title>@yield('title') | GProCongress II</title>
                        ...
                        <form id="registration" action="{{ route('registration') }}" class="row" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-6">
                                <div class="form-check">
                                    ...
                                    <div class="input-box">
                                        <input type="text" onkeypress="return /[a-z A-Z ]/i.test(event.key)"  name="last_name" placeholder=" @lang('web/app.last_name')" required>
            ...
            <div class="footer-menu">
                <ul>
                    ...
                    @if(count($informations) > 0)
                        ...
                        <li>
                            <a href="{{ route('information', [$information->slug]) }}">@if($information->title == 'Privacy Policy') @lang('web/app.Privacy_Policy') @else @lang('web/app.Terms_and_Conditions') @endif </a>
                        </li>
                        @endforeach
                    @endif
                    <li>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(data.otp_verified=='Yes'){
                            ...
                            if (data.token) {
                            // location.href = "{{ route('groupinfo-update') }}";
