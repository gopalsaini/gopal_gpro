            ...
            <div class="step-form">
                ...
                <div class="detail-wrap">
                    <ul>
                        <li>
                            ...
                            <span>:&nbsp; &nbsp; &nbsp; {{$resultData['result']['salutation']}} {{$resultData['result']['name']}} {{$resultData['result']['last_name']}}</span>
                        </li>
                        <li>
                    ...
                    <div class="detail-wrap">
                        ...
                        <ul>
                            @if($SpouseParent)
                                ...
                                <li colspan="2"><strong>Are you coming along with your spouse to the Congress? :</strong> Yes
                                </li>
                                <li>Spouse : {{$SpouseParent->name}} {{$SpouseParent->last_name}}</li>
                            @else
                                <li colspan="2"><strong>Are you coming along with your spouse to the Congress? :</strong> @if($Spouse) Yes @else No @endif
                                </li>
                                @if($Spouse)<li>Spouse : {{$Spouse['name']}} {{$Spouse['last_name']}}</li>@endif
                        ...
                        @if(!$Spouse && $resultData['result']['room'] !=null)
                            <ul>
                                <li colspan="2"><strong>Stay in Twin sharing room or Single Room :</strong> {{$resultData['result']['room']}}
                                </li> 
                            <ul>
                        ...
                        @elseif($Spouse)
                            <ul>
                                <li colspan="2"><strong style="color:red">Spouse confirmation received : {{$Spouse->spouse_confirm_status}}</strong>
                                </li> 
                            <ul>
                        @endif
                ...
                @if($resultData['result']['ministry_pastor_trainer']=='Yes')
                    ...
                    <div class="detail-wrap minister-gap">
                        <ul>
                            ...
                            <li>Are you willing to commit to train one trainer of pastors per year for the next 7 years? : <strong>@if(!empty($ministryYesDetail) && isset($ministryYesDetail['willing_to_commit'])){{$ministryYesDetail['willing_to_commit']}}@endif</strong></li>
                            <li>Comment : <strong>@if(!empty($ministryYesDetail) && isset($ministryYesDetail['comment'])){{$ministryYesDetail['comment']}}@endif</strong></li>
                ...
                @else
                    ...
                    @else
                        ...
                        <label for="" class="d-block">Comment</label>
                        <div class="radio-wrap">
                            <div class="form__radio-group">
                            @if(!empty($resultData['result']['doyouseek_postoralcomment'])){{$resultData['result']['doyouseek_postoralcomment']}}@endif 
                            </div> 
                ...
                @if($resultData['result']['profile_submit_type']=='preview')
                    <div style="display:flex;align-items: center;">
                        <div class="step-next" style="padding: 81px 0 0;;margin-top: 50px;">
                            <a href="{{url('profile-update')}}" class="main-btn bg-gray-btn m-1" >Edit</a>
                        </div>
                        <div class="register-next">
                            <form id="formSubmit" action="{{ route('ministry-details') }}" class="" enctype="multipart/form-data">
                                ...
                                <div class="step-next">
                                    <button type="submit" class="main-btn" form="formSubmit">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header d-block border-0 text-center">
                        <h4 class="main-head">Thank you</h4>
