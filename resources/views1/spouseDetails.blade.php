                            ...
                            <div class="fieldsGroup">
                                <div class="row tbContainer">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" placeholder="Enter Here" class="mt-2"  name="email[]">
                                    </div>
                                    <div class="col-lg-4">
                                        <label for="">@lang('web/spouse-details.whatsapp')</label>
                                        <input type="text" placeholder="Enter Here" class="mt-2"  onkeypress="return /[0-9 ]/i.test(event.key)" name="whatsup[]">
                                    </div>
                                    <div class="col-lg-4">
                                        <label for="">@lang('web/spouse-details.mobile')</label>
                                        <input type="text" placeholder="Enter Here" class="mt-2" onkeypress="return /[0-9 ]/i.test(event.key)"  name="mobile[]">
