                            ...
                            <div class="fieldsGroup">
                                <div class="row tbContainer">
                                    <div class="col-lg-3">
                                        ...
                                        <input type="text" placeholder="Enter Here" class="mt-2 requiredField" name="user_name" value="{{$resultData['result']['name']}}">
                                    </div>
                                    <div class="col-lg-3">
                                        <label for="">@lang('web/group-details.email')</label>
                                        <input type="text" placeholder="Enter Here" class="mt-2 requiredField" name="user_email" value="{{$resultData['result']['email']}}">
                                    </div>
                                    <div class="col-lg-3">
                                        ...
                                        <input style="margin-left: -4px;width: 70%;" type="text" placeholder="Enter Here" class="mt-2 requiredField"  onkeypress="return /[0-9 ]/i.test(event.key)" name="contact_whatsapp_number" value="{{$resultData['result']['contact_whatsapp_number']}}">
                                    </div>
                                    <div class="col-lg-3">
                                        ...
                                        <input style="margin-left:-4px;width: 70%;" type="text" placeholder="Enter Here" class="mt-2 requiredField" onkeypress="return /[0-9 ]/i.test(event.key)" name="contact_business_number" value="{{$resultData['result']['contact_business_number']}}">
                                    </div>  
                                </div>
                                <div class="row tbContainer"> 
                                    <div class="col-lg-3">
                                        <label for="">@lang('web/group-details.name')</label>
                                        <input type="text" placeholder="Enter Here" class="mt-2 requiredField"  name="name[]">
                                    </div>
                                    <div class="col-lg-3">
                                        <label for="">@lang('web/group-details.email')</label>
                                        <input type="text" placeholder="Enter Here" class="mt-2 requiredField"  name="email[]">
                                    </div>
                                    <div class="col-lg-3">
                                        <label for="">@lang('web/group-details.whatsapp')</label>
                                        ...
                                        <input style="margin-left: -4px;width: 70%;" type="text" placeholder="Enter Here" class="mt-2 requiredField" onkeypress="return /[0-9 ]/i.test(event.key)" name="whatsup[]">
                                    </div>
                                    <div class="col-lg-3"> 
                                        <label for="">@lang('web/group-details.mobile')</label>
                                        ...
                                        <input style="margin-left: -4px;width: 70%;" type="text" placeholder="Enter Here" class="mt-2 requiredField" onkeypress="return /[0-9 ]/i.test(event.key)"  name="mobile[]">
