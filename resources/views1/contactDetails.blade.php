                ...
                <ul>
                    <li>
                        <a href="{{url('profile-update')}}" class="active">
                            <span>01</span>@lang('web/contact-details.personal') @lang('web/contact-details.details')
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{url('ministry-details')}}">
                            <span>03</span>@lang('web/contact-details.ministry') @lang('web/contact-details.details')
                        </a>
                    </li>
                </ul>
            </div>
            <div class="step-form">
                ...
                <form id="formSubmit" action="{{ route('contact-details') }}" class="row" enctype="multipart/form-data"> 
                    <div class="col-lg-6">
                        ...
                        <input type="text" autocomplete="text" placeholder="Type in your address here" name="contact_address" required class="active-input mt-2" value="{{$resultData['result']['contact_address']}}">
                    </div>
                    <div class="col-lg-6">
                        <label for="">@lang('web/contact-details.zip')/@lang('web/contact-details.postal') @lang('web/contact-details.code')</label>
                        <input type="text" autocomplete="text" placeholder="Type Your Zip/Postal Code Here" name="contact_zip_code" class="mt-2" value="{{$resultData['result']['contact_zip_code']}}">
                    </div>
                    <div class="col-lg-4">
                        <label for="country">@lang('web/contact-details.country') <span>*</span></label>
                        <div class="common-select">
                            <select id="country" placeholder="- Select -" data-state_id="{{$resultData['result']['contact_state_id']}}" data-city_id="{{$resultData['result']['contact_city_id']}}" class="mt-2 country selectbox test" name="contact_country_id">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="common-select">
                            <select id="alaska" autocomplete="off" placeholder="- Select -" class="mt-2 statehtml test selectbox" name="contact_state_id">
                                
                            </select>
                        </div>
                        
                        <div style="display: @if($resultData['result']['contact_state_id'] == 0) block @else none @endif " id="OtherStateDiv">
                            <input type="text" autocomplete="off" placeholder="Enter @lang('web/contact-details.state')/@lang('web/contact-details.province')" name="contact_state_name" id="ContactStateName" class="mt-2" value="{{$resultData['result']['contact_state_name']}}">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="common-select">
                            <select id="Illinois" autocomplete="off" placeholder="- Select -" class="mt-2 cityHtml test selectbox" name="contact_city_id">
                                
                            </select>
                        </div>
                        <div style="display:@if($resultData['result']['contact_city_id'] == 0) block @else none @endif" id="OtherCityDiv">
                            <input type="text" autocomplete="off" placeholder="Enter @lang('web/contact-details.city')" name="contact_city_name" class="mt-2" id="ContactCityName" value="{{$resultData['result']['contact_city_name']}}">
                        </div>
                    </div>
                    <div class="col-lg-4">
