                ...
                <ul>
                    <li>
                        <a href="{{url('profile-update')}}" class="active">
                            <span>01</span>@lang('web/ministry-details.personal') @lang('web/ministry-details.details')
                        </a>
                    </li>
                    <li>
                        <a href="{{url('contact-details')}}" class="active">
                            <span>02</span>@lang('web/ministry-details.contact') @lang('web/ministry-details.details')
                        </a>
                    </li>
                    <li>
                        <a href="{{url('ministry-details')}}"  class="active">
            ...
            <div class="step-form">
                ...
                <form id="formSubmit" action="{{ route('ministry-details') }}" class="row" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-12">
                        ...
                        <input type="text" autocomplete="text" name="ministry_name" onkeypress="return /[a-z A-Z ]/i.test(event.key)" placeholder="Type  your Ministry Name here" class="active-input mt-2" value="{{$resultData['result']['ministry_name']}}">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="text" autocomplete="text" name="ministry_address" placeholder="Type in your address here" class="mt-2" required value="{{$resultData['result']['ministry_address']}}">
                    </div>
                    <div class="col-lg-6">
                        <label for="">@lang('web/ministry-details.zip')/@lang('web/ministry-details.postal') @lang('web/ministry-details.code')</label>
                        <input type="text" autocomplete="text" name="ministry_zip_code"  placeholder="Type Your Zip/Postal Code Here" class="mt-2" value="{{$resultData['result']['ministry_zip_code']}}">
                    </div>
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div style="display: @if($resultData['result']['ministry_state_id'] == 0) block @else none @endif" id="OtherStateDiv">
                            <input type="text" autocomplete="off" placeholder="Enter @lang('web/contact-details.state')/@lang('web/contact-details.province')" name="ministry_state_name" id="ministryStateName" class="mt-2" value="{{$resultData['result']['ministry_state_name']}}">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        ...
                        <div style="display: @if($resultData['result']['ministry_city_id'] == 0) block @else none @endif" id="OtherCityDiv">
                            <input type="text" autocomplete="off" placeholder="Enter @lang('web/ministry-details.city')" name="ministry_city_name" id="ministryCityName" class="mt-2" value="{{$resultData['result']['ministry_city_name']}}">
                        </div>
