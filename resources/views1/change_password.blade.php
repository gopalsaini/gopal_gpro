            ...
            <div class="step-form">
                ...
                <form id="formSubmit" action="{{ route('user.change-password') }}" class="row" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-12">
                        ...
                        <input type="password" name="old_password" required placeholder="Enter Old Password" class="active-input mt-2" >
                    </div>
                    <div class="col-lg-12">
                        <label for="">@lang('web/change-password.enter') @lang('web/change-password.new') @lang('web/change-password.password')<span>*</span></label>
                        <input type="password" name="new_password" placeholder="Enter New Password" class="mt-2" required >
                    </div>
                    <div class="col-lg-12">
                        ...
                        <input type="password" name="confirm_password" placeholder="Enter Confirm  Password" class="mt-2" required >
                    </div>
                    <div class="col-lg-6">
                        <div class="step-next">
