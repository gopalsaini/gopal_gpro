...
return [
    ...
    */
    ...
    'arrival-to-panama-attendee' => 'Arrival to Panama ',
    ...
    'user-information-only' => 'Check in Info :',
    'user-information-only2' => 'Checkout Info :',
    'spouse-picked-by-gpro-from-airport' => 'Would you like to be picked by GProCongress from Airport(PTY)',
    'spouse-dropped-by-gpro-at-airport' => 'Would you like to be dropped by GProCongress at Airport(PTY)',
    'flight-details-landing-in-panama' => 'Please fill in Flight details of the Flight landing in Panama or departing from Panama',
    'travel_note'=>'PLEASE NOTE: You are not guaranteed to receive the roommate you have selected. GProCongress II organizers will do their best to honor roommate requests. The best way to ensure you are placed with your requested roommate is for that delegate to also select you as his/her roommate',
    'like_to_share_your_room'=>'Select your preferred roommate:',
    'Married'=>'Married',
    'Unmarried'=>'Unmarried',
    'submit' => 'Submit',
    'enter' => 'Enter',
